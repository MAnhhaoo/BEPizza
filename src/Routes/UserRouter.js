...
router.get("/getAlluser" , authMiddleware,userController.getAlluser.bind(userController));
router.delete("/deleteUser/:id",authMiddleware, userController.deleteUser.bind(userController))
